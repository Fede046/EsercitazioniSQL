...
CREATE TABLE INSEGNAMENTO(
    ...
    CodiceCL INT ,
    CFU INT ,
    SSD ENUM('INF','ING-INF','SECS','IUS','MAT') NOT NULL,
    NumIscritti INT ,
    MaxIscritti INT,
    Foreign Key (CodiceCL) REFERENCES CORSOLAUREA(Codice)
);
...
INSERT INTO DIPARTIMENTO (Nome, Sede, NumeroDocenti) VALUES ('DISI', 'Bologna', 30);
INSERT INTO DIPARTIMENTO (Nome, Sede, NumeroDocenti) VALUES ('DISA', 'Bologna', 85);
INSERT INTO DIPARTIMENTO (Nome, Sede, NumeroDocenti) VALUES ('MAT', 'Bologna', 110);
...
INSERT INTO CORSOLAUREA (Codice, Nome, NomeDip, NumeroProgrammato) VALUES (8014, 'InfoMan', 'DISI', 'Nonattivo');
INSERT INTO CORSOLAUREA (Codice, Nome, NomeDip, NumeroProgrammato) VALUES (6061, 'Matematica', 'MAT', 'Attivo');
INSERT INTO CORSOLAUREA (Codice, Nome, NomeDip, NumeroProgrammato) VALUES (6610, 'Economia Aziendale', 'DISA', 'Attivo');
...
INSERT INTO STUDENTE (Matricola, CodiceCL, Nome, Cognome, CFUConseguiti) VALUES (2, 8014, 'Maria', 'Rossi', 18);
INSERT INTO STUDENTE (Matricola, CodiceCL, Nome, Cognome, CFUConseguiti) VALUES (3, 8014, 'Giulia', 'Neri', 0);
INSERT INTO STUDENTE (Matricola, CodiceCL, Nome, Cognome, CFUConseguiti) VALUES (4, 8014, 'Paolo', 'Verdi', 24);
INSERT INTO STUDENTE (Matricola, CodiceCL, Nome, Cognome, CFUConseguiti) VALUES (5, 8014, 'Chiara', 'Marrone', 6);

SELECT * FROM STUDENTE;


-- INSERT ripetuti per INSEGNAMENTO
INSERT INTO INSEGNAMENTO (Id, Nome, CodiceCL, CFU, SSD, NumIscritti, MaxIscritti) VALUES (1, 'Apprendimento automatico', 8019, 6, 'INF', 0, 0);
INSERT INTO INSEGNAMENTO (Id, Nome, CodiceCL, CFU, SSD, NumIscritti, MaxIscritti) VALUES (2, 'Lab Making', 8019, 6, 'INF', 0, 0);
INSERT INTO INSEGNAMENTO (Id, Nome, CodiceCL, CFU, SSD, NumIscritti, MaxIscritti) VALUES (3, 'Ottimizzazione', 6061, 6, 'MAT', 0, 5);
INSERT INTO INSEGNAMENTO (Id, Nome, CodiceCL, CFU, SSD, NumIscritti, MaxIscritti) VALUES (4, 'Diritto Privato', 6610, 6, 'IUS', 0, 3);
INSERT INTO INSEGNAMENTO (Id, Nome, CodiceCL, CFU, SSD, NumIscritti, MaxIscritti) VALUES (5, 'Economia Aziendale', 6610, 6, 'SECS', 0, 250);
...
BEGIN
        ...
        if contatore>0 then
            INSERT INTO VERBALIZZAZIONE(Matricola,IdInsegnamento,Data,voto) VALUES
            (Mat,Ins,CURRENT_DATE,Vt)
        end if;
END$
DELIMITER ;
